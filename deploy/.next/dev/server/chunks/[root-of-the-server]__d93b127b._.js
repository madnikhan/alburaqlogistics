...
async function POST(request) {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            success_url: `${("TURBOPACK compile-time value", "http://localhost:3000") || 'http://localhost:3000'}/booking-success?session_id={CHECKOUT_SESSION_ID}&booking_id=${bookingId}`,
            cancel_url: `${("TURBOPACK compile-time value", "http://localhost:3000") || 'http://localhost:3000'}/book?canceled=true`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d93b127b._.js.map